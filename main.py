    ...
    while True:
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                console.print("[bold cyan][!] Enter Car Details.[/bold cyan]")
                car_id = IntPrompt.ask("[bold][?] Car ID[/bold]")
                angle = IntPrompt.ask("[bold][?] Steering Angle (0-90)[/bold]", default=90)

                console.print("[bold cyan][%] Setting Steering Angle[/bold cyan]:", end=None)
                if cpm.car_set_steering_angle(car_id, angle):
                    console.print("[bold green]SUCCESSFUL (✔)[/bold green]")
                    console.print("================================")
                    answ = Prompt.ask("[?] Do you want to exit?", choices=["y", "n"], default="n")
                    if answ == "y":
                        print(Colorate.Horizontal(Colors.rainbow, "Thank you for using our tool!"))
                        break
                else:
                    print(Colorate.Horizontal(Colors.rainbow, "FAILED."))
                    print(Colorate.Horizontal(Colors.rainbow, "[!] Please use valid values."))
